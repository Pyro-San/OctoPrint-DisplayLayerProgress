...
class DisplaylayerprogressPlugin(
    ...
    def _updateDisplay(self):
        ...
        # TODO better string subtitution
        # see https://www.safaribooksonline.com/library/view/python-cookbook-2nd/0596007973/ch01s19.html
        printerMessageCommand = "M117 " + self._settings.get([SETTINGS_KEY_PRINTERDISPLAY_MESSAGEPATTERN]).replace(
            PROGRESS_EXPRESSION, self._progress)
        ...
        navBarMessage = self._settings.get([SETTINGS_KEY_NAVBAR_MESSAGEPATTERN]).replace(PROGRESS_EXPRESSION,
                                                                                         self._progress)
